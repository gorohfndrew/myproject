...
from .templates.ads.models import Ad, Category  # Модели
from .templates.ads.serializers import AdSerializer, CategorySerializer  # Сериализаторы
from .templates.ads.forms import AdForm  # Импортируем форму AdForm
...
# Представление для регистрации (убрал дублирование)
class RegisterView(CreateView):
    form_class = UserCreationForm
    template_name = "ads/register.html"  # Убедитесь, что этот шаблон существует
    success_url = '/ads/list/'  # Путь к списку объявлений 
...
# Представление для категории объявлений
